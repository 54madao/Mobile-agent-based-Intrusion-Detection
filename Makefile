...
#  opp_makemake -f -r --deep -o CastaliaBin -u Cmdenv -P /home/wenbog/Documents/Castalia-3.2 -M release -X Simulations -X out -X bin -lboost_serialization -lopencv_core -lopencv_ml
#
...
LIBS =  -lboost_serialization -lopencv_core -lopencv_ml
...
OBJS = \
    ...
    $O/src/node/application/IDSTest/DetectionModel.o \
    $O/src/node/application/IDSTest/IDSTest.o \
    $O/src/node/application/IDSTest/SensorAgent.o \
    ...
    $O/src/node/application/IDSTest/AgentPacket_m.o \
...
MSGFILES = \
    ...
    src/node/application/IDSTest/AgentPacket.msg \
...
clean:
	...
	$(Q)-rm -f src/node/application/IDSTest/*_m.cc src/node/application/IDSTest/*_m.h
...
$O/src/node/application/connectivityMap/ConnectivityMap.o: src/node/application/connectivityMap/ConnectivityMap.cc \
  ...
  src/helpStructures/TimerServiceMessage_m.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/application/IDSTest/DetectionModel.o: src/node/application/IDSTest/DetectionModel.cc \
  src/node/application/IDSTest/DetectionModel.h
$O/src/node/application/IDSTest/IDSTest.o: src/node/application/IDSTest/IDSTest.cc \
  src/node/application/IDSTest/IAgent.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/node/application/IDSTest/DetectionModel.h \
  src/CastaliaMessages.h \
  src/node/application/IDSTest/AgentPacket_m.h \
  src/node/resourceManager/ResourceManagerMessage_m.h \
  src/helpStructures/TimerService.h \
  src/helpStructures/TimerServiceMessage_m.h \
  src/node/application/ApplicationPacket_m.h \
  ...
  src/node/resourceManager/ResourceManager.h \
  src/node/communication/mac/MacPacket_m.h \
  src/node/application/IDSTest/IDSTest.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/node/application/IDSTest/SensorAgent.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/application/VirtualApplication.h \
  src/helpStructures/CastaliaModule.h \
  src/node/communication/radio/Radio.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioControlMessage_m.h
$O/src/node/application/IDSTest/SensorAgent.o: src/node/application/IDSTest/SensorAgent.cc \
  src/node/application/IDSTest/DetectionModel.h \
  src/node/application/IDSTest/IAgent.h \
  src/node/application/IDSTest/SensorAgent.h
